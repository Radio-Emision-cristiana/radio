class RadioPlayer {
    ...
    onPlay() {
        // Asegurar que las animaciones estén activas cuando se reproduce
        this.isPlaying = true;
        this.updatePlayButtons();
        this.albumArt.classList.add('playing');
        ...
        console.log('Audio onPlay triggered - Animaciones activadas');
    }

    // Cuando se pausa la reproducción
    onPause() {
        // Asegurar que las animaciones se detengan cuando se pausa
        this.isPlaying = false;
        this.updatePlayButtons();
        this.albumArt.classList.remove('playing');
        ...
        console.log('Audio onPause triggered - Animaciones desactivadas');
    }
            ...
            if (this.isConnected && !this.isPlaying) {
                this.audio.play()
                    .then(() => {
                        ...
                        // IMPORTANTE: Activar estado de reproducción y animaciones
                        this.isPlaying = true;
                        this.updatePlayButtons();
                        this.albumArt.classList.add('playing');
                    ...
                    .catch(error => {
                        ...
                        const startOnInteraction = () => {
                            if (!this.isPlaying && this.isConnected) {
                                this.play(); // Este método ya activa las animaciones correctamente
                            }
